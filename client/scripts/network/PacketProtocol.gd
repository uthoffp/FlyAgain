...
const OPCODE_CHARACTER_LIST_REQUEST    := 0x0008
const OPCODE_CHARACTER_LIST_RESPONSE   := 0x0009
...
static func opcode_name(opcode: int) -> String:
	match opcode:
		...
		OPCODE_CHARACTER_LIST_REQUEST:  return "CHARACTER_LIST_REQUEST"
		OPCODE_CHARACTER_LIST_RESPONSE: return "CHARACTER_LIST_RESPONSE"
		OPCODE_HEARTBEAT:          return "HEARTBEAT"
		OPCODE_SERVER_MESSAGE:     return "SERVER_MESSAGE"
		OPCODE_ERROR_RESPONSE:     return "ERROR_RESPONSE"
		OPCODE_LOGOUT_REQUEST:     return "LOGOUT_REQUEST"
		...
		OPCODE_POSITION_CORRECTION: return "POSITION_CORRECTION"
		OPCODE_MOVEMENT_INPUT:     return "MOVEMENT_INPUT"
